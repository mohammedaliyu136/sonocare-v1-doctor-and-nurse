            ...
            children: [
              ...
              if(!authProvider.isLoading)normalButton(
                ...
                onTap: (){
                  ...
                  authProvider.email_verification(email_verification_code: email_verification_code, email: widget.email).then((ResponseModel responseModel){
                    if(responseModel.isSuccess){
                      showCustomSnackBar(responseModel.message, context, isError: false);
                      authProvider.loginNotVerified(widget.email, widget.password).then((ResponseModel responseModel){
                        if(responseModel.isSuccess){
