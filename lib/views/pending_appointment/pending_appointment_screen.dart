                        ...
                        children: List.generate(appointmentProvider.pendingAppointments.length, (index) {
                          return GestureDetector(
                            onTap: (){
                              ...
                              Provider.of<AppointmentProvider>(context, listen: false).getAppointmentDetail(context, appointmentProvider.pendingAppointments[index].id,token, index);
                              Provider.of<AppointmentProvider>(context, listen: false).getPatientDetail(context, appointmentProvider.pendingAppointments[index].patientID);
                              Navigator.push(
                                context,
