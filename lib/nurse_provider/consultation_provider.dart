...
class ConsultationProvider with ChangeNotifier {
  ...
  Future<ResponseModelNurse> setConsultationFee(BuildContext context,String token, ServiceFeeModel serviceFeeModel,) async {
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      _responseModel = ResponseModelNurse(true, responseBody['message']);
    } else {
