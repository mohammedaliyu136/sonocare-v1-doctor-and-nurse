...
import 'package:doctor_v2/nurse_views/wallet/wallet_settings.dart';
          ...
          Padding(
            ...
            child: normalButton(
              ...
              onTap: (){
                ...
                Provider.of<NurseWalletProvider>(context, listen: false).withDrawFunds(token, requestAmountController.text);
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  void initState() {
    String token = Provider.of<NurseAuthProvider>(context, listen: false).token;
    Provider.of<NurseWalletProvider>(context, listen: false).getTransactions(context, token);
    super.initState();
  }
    ...
    return Stack(children: [
      ...
      Padding(
        ...
        child: Scaffold(
          ...
          body: Consumer<NurseWalletProvider>(
