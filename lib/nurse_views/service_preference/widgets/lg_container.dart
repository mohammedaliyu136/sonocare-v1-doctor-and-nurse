      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            Padding(
              padding: const EdgeInsets.only(bottom: 8.0),
              child: Text(title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Colors.black, letterSpacing: 1.12, height: 1.5),),
            ),
            Image.asset('assets/icons/right-arrow_icon.png')
          ],),
        ),
      ),
    ),
