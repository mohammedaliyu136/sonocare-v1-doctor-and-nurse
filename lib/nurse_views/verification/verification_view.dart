...
import 'package:doctor_v2/nurse_views/otp/widgets/not_approved.dart';
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          body: Consumer<FormVerificationNurseProvider>(
              builder: (context, formVerificationProvider, child) {
              return Consumer<VerificationNurseProvider>(
                      ...
                      return Column(
                        ...
                        Row(
                          ...
                          Column(children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text('Business Information', style: TextStyle(color: Colors.white),),
                            )
                          ],)
                        ],),
                          SizedBox(height: 20,),
                          ...
                          onTap: ()async{
                            if(step!=4){
                              ...
                              if(verificationModel.verified){
                                ...
                                print('------------------------');
                                print(formVerificationProvider.getStep1(Provider.of<NurseAuthProvider>(context, listen: false).nurseTypeList[0].title));
                                ...
                                await verificationProvider.startUpload(
                                    step1: formVerificationProvider.getStep1(Provider.of<NurseAuthProvider>(context, listen: false).nurseTypeList[0].title),
