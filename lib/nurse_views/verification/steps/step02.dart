...
import 'package:doctor_v2/nurse_views/verification/model/model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<FormVerificationNurseProvider>(
        ...
        return Column(children: [
          ...
          SizedBox(height: 15,),
          textField(label: 'Account Name', icon: Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter Account Name', controller: formVerificationProvider.accountNameController, validator: (){}, onChanged: (){}),
          SizedBox(height: 15,),
          textField(label: 'Account Number', icon: Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter Account Number', controller: formVerificationProvider.accountNumberController, validator: (){}, onChanged: (){}),
          SizedBox(height: 15,),
          textField(label: 'Bank', icon: Icon(Icons.account_circle_outlined, color: Colors.transparent,), hintText: 'Enter Bank Code', controller: formVerificationProvider.bankCodeController, validator: (){}, onChanged: (){}),
          SizedBox(height: 15,),
        ],);
      }
    );
