    ...
    return Consumer<FormVerificationNurseProvider>(
        ...
        return Column(children: [
          ...
          GestureDetector(
              ...
              child: textField(label: 'Education/Nursing Certificate', icon: Icon(Icons.upload_rounded, color: Colors.white,), hintText: 'Select Degree Certificate', controller: formVerificationProvider.degreeCertificateController, validator: (){}, onChanged: (){}, enable: false,)),
          SizedBox(height: 15,),
          GestureDetector(
              onTap: ()=>formVerificationProvider.takeNigeriaMedicalLicense(),
              child: textField(label: ' Nursing/Practicing License', icon: Icon(Icons.upload_rounded, color: Colors.white,), hintText: 'Select Nigeria Medical License', controller: formVerificationProvider.nigeriaMedicalLicenseController, validator: (){}, onChanged: (){}, enable: false,)),
          SizedBox(height: 15,),
          GestureDetector(
