    ...
    return Stack(children: [
      ...
      Padding(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.transparent,
            title: Text('Pending Appointment'),
            elevation: 0,
                ...
                if(appointmentProvider.isLoading){
                  ...
                  return Padding(
                    ...
                    child: ListView(children: [
                      ...
                      Column(
                        children: List.generate(appointmentProvider.pendingAppointments.length, (index) {
                          return GestureDetector(
                            onTap: (){
                              String token = Provider.of<NurseAuthProvider>(context, listen: false).token;
                              Provider.of<AppointmentNurseProvider>(context, listen: false).getAppointmentDetail(context, appointmentProvider.pendingAppointments[index].id,token, index);
                              Provider.of<AppointmentNurseProvider>(context, listen: false).getPatientDetail(context, appointmentProvider.pendingAppointments[index].patientID);
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => AcceptAppointmentScreen(appointment:appointmentProvider.pendingAppointments[index])),
                              );
                            },
                            child: Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          //image:DecorationImage(
                                            ...
                                            //image: NetworkImage(AppConstants.BASE_URL+appointmentProvider.pendingAppointments[index]!.image),
                                          //)
                                      ),

                                      child: Image.network(
                                        AppConstants.BASE_URL+appointmentProvider.pendingAppointments[index].image,
                                        fit: BoxFit.cover,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(appointmentProvider.pendingAppointments[index].patientName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w400),),
                                        SizedBox(height: 10,),
                                        Row(
                                          children: [
                                            Text(appointmentProvider.pendingAppointments[index].getDate(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400),),
                                            SizedBox(width: 20,),
                                            Text(appointmentProvider.pendingAppointments[index].getTime(), style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400),),
                                          ],
                                        ),
                                      ],)
                                  ],),
