...
import 'package:doctor_v2/data/repository/schedule_repo.dart';
...
class ScheduleProvider with ChangeNotifier {
  ...
  Future<ResponseModel> getSchedules(BuildContext context,String token, {day='1', index=0}) async {
    _isLoading = true;
  ...
  Future<ResponseModel> createSchedule(BuildContext context,String token, time, day) async {
  ...
  Future<ResponseModel> deleteSchedule(BuildContext context,String token, ScheduleModel scheduleModel) async {
    _isLoadingSetTime = true;
    notifyListeners();
    ResponseModel _responseModel;
