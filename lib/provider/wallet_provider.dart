...
import 'package:doctor_v2/data/repository/wallet_repo.dart';
...
class WalletProvider with ChangeNotifier{
  ...
  Future<ResponseModel> getTransactions(BuildContext context,String token) async {
    ...
    WalletRepo walletRepo = WalletRepo(remoteClient: remoteClient, sharedPreferences: sharedPreferences);
