...
class StateRepository {
  ...
  List<Map<String, dynamic>> _nigeria = [
    {
      "state": "Adamawa",
      "alias": "adamawa",
      "lgas": [
  ...
  /*
  List<Map<String, dynamic>> getAll() => _nigeria;
  ...
  */
  ...
  getLGA_v1(id) async {
    ...
    print(response.body);
    List<LgaModelPAC> lgas = [];
    for (var i = 0; i < jsonDecode(response.body)['LGA'].length; i++) {
      lgas.add(LgaModelPAC.fromJson(jsonDecode(response.body)['LGA'][i]));
    }
    return lgas;
  }
