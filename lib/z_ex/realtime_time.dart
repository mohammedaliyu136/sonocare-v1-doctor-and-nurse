...
class RealTimeTime extends StatefulWidget {
  RealTimeTime({Key? key}) : super(key: key);

  @override
  _RealTimeTimeState createState() {
    return _RealTimeTimeState();
  }
}

class _RealTimeTimeState extends State<RealTimeTime> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        TextButton(onPressed: (){
          _counterSubscription = databaseRef.onChildAdded.listen((Event event) {
            setState(() {
              print(event.snapshot.value ?? 0);
              print('-----------------------');
            });
